...
const triangleArea: number = (a * c) / 2;
const circleArea: number = 3.14159 * c * c;
const trapezoidArea: number = ((a + b) * c) / 2;
const squareArea: number = b * b;
const rectangleArea: number = a * b;
